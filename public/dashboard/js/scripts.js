(function($) {
    ...
    function calculate_invest() {
        var amt = parseFloat($('#invest-amt').val()),
            period = parseFloat($('#invest-period').val()),
            profit, total, perc, walbal = parseFloat(wallet.attr('value'));
    ...
    // function AtgPaybackProcess__(reference) {

    //     $.ajax({
    //         url: $('#atgCallbackUrl_').val(),
    //         type: "POST",
    ...
    // AtgPaybackProcess__('hhhhhhhh44');

    // function callAtgPay(e) {
    //     // return AtgPaybackProcess__('hhhhhhhh44');
    //     // e.preventDefault()
    //     AtgPayment.pay({
