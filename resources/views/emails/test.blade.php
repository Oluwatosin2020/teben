...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="web/images/bg_1.jpg">
...
<body style="background-image:url(web/images/bg_1.jpg);">
  <div class="container" style="opacity: 0.11" >
      <div>
    Hi, This is : {{ $name }}
</div>
...
<!-- offset area start -->
    ...
    <!-- <script src="dashboard/js/jquery-3.3.1.js"></script> -->
    <!-- bootstrap 4 js -->
