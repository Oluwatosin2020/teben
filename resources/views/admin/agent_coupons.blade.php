          ...
          <div class="section-body">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4>{{$agent->user->name}} Coupon Codes
                    <span style="float:right"> <button class="btn-sm btn-outline-primary" data-toggle="modal" data-target="#sellcoupons">Sell Coupons</button> </span>
                    </h4>
                  </div>
                  <div class="card-body">
            ...
            <!--Add coupon Modal -->
                                          <!--Add coupon Modal -->
                                 <div class="modal fade bd-example-modal-md" id="sellcoupons">
                                    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Sell New Coupons</h5>
                                                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                            </div>
                                            <div class="modal-body">
